...
class SystemState(object):
    ...
    def clear_outdated_error_markers(self):
        ...
        for i in self.domdict.keys():
            ...
            if self.domdict[i].memory_actual <= \
                    ...
                    vanir.qmemman.algo.prefmem(self.domdict[i]):
    ...
    def do_balloon(self, memsize):
        ...
        while True:
            ...
            memset_reqs = vanir.qmemman.algo.balloon(memsize + self.XEN_FREE_MEM_LEFT - xenfree, self.domdict)
    ...
    def is_balance_req_significant(self, memset_reqs, xenfree):
        ...
        for rq in memset_reqs:
            ...
            pref = vanir.qmemman.algo.prefmem(self.domdict[dom])
    ...
    def do_balance(self):
        ...
        if os.path.isfile('/var/run/vanir/do-not-membalance'):
        ...
        xenfree = self.get_free_xen_memory()
        memset_reqs = vanir.qmemman.algo.balance(xenfree - self.XEN_FREE_MEM_LEFT, self.domdict)
