...
__author__ = 'Cybertrigo'
__license__ = 'Mit or later'
__version__ = 'R1'
...
class Label:
    ...
    When this is a :py:class:`vanir.vm.dispvm.DispVM`, padlock is overlayed
...
class property:  # pylint: disable=redefined-builtin,invalid-name
    ...
    :file:`vanir.xml`. It is used for both global and per-VM properties.
    ...
    :param int load_stage: stage when property should be loaded (see \
        :py:class:`vanir` for description of stages)
    ...
    def __init__(self, name, setter=None, saver=None, type=None,
        ...
        self.clone = clone
        self.__doc__ = doc
        self._attr_name = '_vanirprop_' + name
    ...
    def __get__(self, instance, owner):
        ...
        if not isinstance(instance, PropertyHolder):
            raise AttributeError('vanir.property should be used on '
                'vanir.PropertyHolder instances only')
    ...
    def sanitize(self, *, untrusted_newvalue):
        ...
        setter. Can raise VanirValueError if the value is invalid.
        :param untrusted_newvalue: value to be validated
        :return: sanitized value
        :raises: vanir.exc.VanirValueError
        '''
...
class PropertyHolder(vanir.events.Emitter):
    '''Abstract class for holding :py:class:`vanir.property`
    ...
    def _property_init(self, prop, value):
        ...
        :param vanir.property prop: property object of particular interest
        :param value: value
        '''
    ...
    def property_get_default(self, prop):
        ...
        :param vanir.property or str prop: property object of particular
        interest
        '''
    ...
    def property_get_def(cls, prop):
        ...
        If prop is already :py:class:`vanir.property` instance, return the same
        object.
        :param prop: property object or name
        :type prop: vanir.property or str
        :rtype: vanir.property
        '''

        if isinstance(prop, vanir.property):
            return prop
...
from vanir.vm import VMProperty
from vanir.app import vanir
