...
class TC_50_MimeHandlers:
    ...
    def open_file_and_check_viewer(self, filename, expected_app_titles,
        ...
        wait_count = 0
        winid = None
        with self.qrexec_policy('vanir.OpenInVM', self.source_vm.name,
                self.target_vmname):
            with self.qrexec_policy('vanir.OpenURL', self.source_vm.name,
                    self.target_vmname):
                while True:
    ...
    def test_010_url(self):
        self.open_file_and_check_viewer("https://www.vanir-os.org/", [],
...
def create_testcases_for_templates():
    return vanir.tests.create_testcases_for_templates('TC_50_MimeHandlers',
        TC_50_MimeHandlers, vanir.tests.SystemTestCase,
