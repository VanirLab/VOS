...
class TC_00_Dom0(SaltTestMixin, vanir.tests.SystemTestCase):
    ...
    def test_020_vanir_pillar(self):
        ...
        self.assertIn('local', cmd_output)
        self.assertIn('vanir', cmd_output['local'])
        vanir_pillar = cmd_output['local']['vanir']
        self.assertEqual(vanir_pillar, {
            'type': 'app',
            'netvm': str(vm.netvm),
...
def create_testcases_for_templates():
    return vanir.tests.create_testcases_for_templates('TC_10_VMSalt',
        SaltVMTestMixin, vanir.tests.SystemTestCase,
