...
class TC_00_BackupCompatibility(
        vanir.tests.integ.backup.BackupTestsMixin, vanir.tests.SystemTestCase):
    ...
    def create_v1_files(self, r2b2=False):
        ...
        os.symlink("/usr/share/vanir/icons/green.png",
        ...
        os.symlink("/usr/share/vanir/icons/blue.png",
    ...
    def calculate_hmac(self, f_name, algorithm="sha512", password="vanir"):
    ...
    def handle_v3_file(self, f_name, subdir, stream, compressed=True,
        ...
        if encrypted:
            encryptor = subprocess.Popen(
                ["openssl", "enc", "-e", "-aes-256-cbc", "-pass", "pass:vanir"],
                stdin=tar.stdout,
    ...
    def create_v3_backup(self, encrypted=True, compressed=True):
        """
        Create "backup format 3" backup - used in R1
        ...
        f = open(self.fullpath("vanir.xml"), "w")
        if encrypted:
            qubesxml = VANIRXML_R2
        ...
        self.handle_v3_file("vanir.xml", "", output, encrypted=encrypted,
                            compressed=compressed)
    ...
    def test_210_r2(self):
        ...
        common_props = {
            ...
            'kernel': vanir.property.DEFAULT,
            'kernelopts': vanir.property.DEFAULT,
            'qrexec_timeout': vanir.property.DEFAULT,
            'netvm': vanir.property.DEFAULT,
            'default_user': vanir.property.DEFAULT,
        ...
        self.assertRestored("test-template-clone",
            klass=vanir.vm.templatevm.TemplateVM,
            label='green',
        ...
        self.assertRestored("test-standalonevm",
            klass=vanir.vm.standalonevm.StandaloneVM,
            label='blue',
            **template_standalone_props)
